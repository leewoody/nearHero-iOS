                                      ...
                                      type:(NSUInteger)type
{
    ...
    if (self)
    {
        self.shouldShowRightView=false;
        _type = type;

        // -----

        _leftViewController = [[SideMenuViewController alloc]initWithNibName:@"SideMenuViewController" bundle:nil];
        _rightViewController = [[SideMenuViewController alloc]initWithNibName:@"SideMenuViewController" bundle:nil];

        // -----

        if (type == 0)
        {
            [self setLeftViewEnabledWithWidth:235.f
...
//        [_leftViewController.tableView reloadData];
        [_leftViewController.view setFrame:CGRectMake(0, 0, _leftViewController.view.frame.size.width, self.view.frame.size.height)];
