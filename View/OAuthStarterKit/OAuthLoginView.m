...
- (void)testApiCall
{
  //  NSURL *url = [NSURL URLWithString:@"https://api.linkedin.com/v1/people/~"];
    NSURL *url = [NSURL URLWithString:@"https://api.linkedin.com/v1/people/~/connections?oauth2_access_token=SOME ACCESS TOKEN&modified=new%20HTTP/1.1"];
...
{
    apikey = @"81q5g6p7mkvfdj";
    secretkey = @"PdqTk1t3Eo6XeNS9";
